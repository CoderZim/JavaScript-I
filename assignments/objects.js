...
parent.speak= function () { return "Hello, how are you" }
console.log(parent.speak());
// Have the child speak
parent.child.speak= function () { return "Hi, mom we're good" }
console.log(parent.child.speak());
// Have the grandchild speak
parent.child.grandchild.speak= function () { return "I wanna play outside!" }
